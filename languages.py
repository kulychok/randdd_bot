...
help = {
    'en': '''*Bot's actions in bot's chat:* 
...
coin_flipping_button = {
    'en': 'Heads or tails', 
    'ru': 'Орёл или решка', 
    'ua': 'Орел або решка'
}
coin_flipping_inline_description = {
    'en': "Press __Start__ to run _Coin flipping_",
